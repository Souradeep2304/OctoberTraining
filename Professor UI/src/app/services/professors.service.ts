...
import { ProfessorDto, AddProfessorDto } from '../interfaces/professor.Dto';
...
export class ProfessorsService {
 ...
 AddProfessor(Professor: AddProfessorDto): Observable<AddProfessorDto> {
    return this.httpClient.post<AddProfessorDto>(`${baseUrl}/professors/`, JSON.stringify(Professor), httpOptions)
        .pipe(
            retry(1),
